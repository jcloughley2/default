...
<section id="content" role="main">
	...
	<div class="recruit">
		<div class="recruit-inner">
			...
			<div class="recruit-2">
				<div class="circle">
					...
					<div class="quadrant marketing quadrant-top">
					...
					<div class="quadrant meaning quadrant-top">
						<div class="quadrant-inner">
						<h3>Meaning</h3>
						<p>We ensure that each member of FiveTwelve stays competitive within their industry</p>
						</div>
					...
					<div class="quadrant mental-health quadrant-bottom">
						<div class="quadrant-inner">
						<h3>Mental Health</h3>
						<p>We ensure that each member of FiveTwelve stays competitive within their industry</p>
						</div>
					...
					<div class="quadrant money quadrant-bottom">
						<div class="quadrant-inner">
						<h3>Money</h3>
						<p>We ensure that each member of FiveTwelve stays competitive within their industry</p>
						</div>
		...
		<div class="why-mountians">
				<div class="why-mountians-inner">
			<a href="#">Why Mountains?</br />Why 512</a>
					</div>
		</div>
	</div>
	<div class="slider-container">
		<h2 class="slider-header">What makes FiveTwelve, FiveTelve?</h2>
		<div class="slider">
